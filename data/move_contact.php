...
//Perform update
$sql = "UPDATE contacts SET group_id = ".mysqli_real_escape_string($conn, $group_id )." WHERE id = ".mysqli_real_escape_string($contact_id);
$result = mysqli_query($sql) or die("Could not move contact in database");
//Check if performed via Ajax
if(mysqli_affected_rows() > 0 && $_POST['move_contact_ajax'] == "0") {
